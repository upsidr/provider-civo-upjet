...
PROJECT_NAME := provider-civo-upjet
PROJECT_REPO := github.com/upsidr/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION := 1.0.29
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-civo
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-civo_v1.0.29
...
xpkg.build.provider-civo-upjet: do.build.images
